...
const Featuredjob = ({job}) => {
    console.log(job)
    const {title, company, location, job_type, posted_date,salary}  = job
 console.log(company.logo)
    return (
        <div className='shadow-sm hover:shadow-md hover:pt-11 bg-white w-9/10 mx-auto py-10 px-5 sm:flex justify-between items-center mt-7'>
             <div className='gap-5 flex items-start   '>
                ...
                <div>
                    ...
                    <button className='btn text-accent py-6 bg-gray-100 text-lg hover:bg-white hover:text-black px-5 w-full sm:w-30 hover:shadow-md'>Apply</button>
